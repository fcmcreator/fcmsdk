package io.boc.v2.service;

import io.boc.v2.SDKContext;
import io.boc.v2.base.Address;
import io.boc.v2.base.AddressTool;
import io.boc.v2.base.Transaction;
import io.boc.v2.constant.Constant;
import io.boc.v2.crypto.HexUtil;
import io.boc.v2.error.ContractErrorCode;
import io.boc.v2.exception.CommonCodeConstanst;
import io.boc.v2.exception.ErrorCode;
import io.boc.v2.model.Result;
import io.boc.v2.util.AccountTool;
import io.boc.v2.util.ContractUtil;
import io.boc.v2.util.StringUtils;
import io.boc.v2.parse.MapUtils;
import io.boc.v2.txdata.CallContractData;
...
import static io.boc.v2.exception.CommonCodeConstanst.NULL_PARAMETER;
import static io.boc.v2.constant.Constant.CONTRACT_MINIMUM_PRICE;
import static io.boc.v2.constant.Constant.MAX_GASLIMIT;
import static io.boc.v2.error.AccountErrorCode.ADDRESS_ERROR;
import static io.boc.v2.error.ContractErrorCode.CONTRACT_ALIAS_FORMAT_ERROR;
import static io.boc.v2.util.ValidateUtil.validateChainId;
