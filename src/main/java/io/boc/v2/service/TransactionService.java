...
import static io.boc.v2.SDKContext.NULS_DEFAULT_OTHER_TX_FEE_PRICE;
import static io.boc.v2.constant.AccountConstant.ALIAS_FEE;
...
import io.boc.v2.constant.AccountConstant;
...
public class TransactionService {
    ...
    public static Result signTx(String txHex, String address, String privateKey) {
        ...
        return BocSDKTool.sign(signDtoList, txHex);
    }
